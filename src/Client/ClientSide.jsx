    ...
    return (
      ...
      <div
        ...
        <li className="mb-4 mt-5">
            <Link to="/client" style={{ textDecoration: 'none', color: 'black', display: 'flex', alignItems: 'center' }}>
              <FaHome className="me-2" /> HOME
            </Link>
          </li>
          <li>
            <Link to="/client/clientdash" style={{ textDecoration: 'none', color: 'black', display: 'flex', alignItems: 'center' }}>
