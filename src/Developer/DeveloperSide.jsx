    ...
    return (
      ...
      <div
        ...
        <li className="mb-4 mt-5">
            <Link to="/developer" style={{ textDecoration: 'none', color: 'black', display: 'flex', alignItems: 'center' }}>
              <FaHome className="me-2" /> HOME
            </Link>
          </li>
          <li>
            <Link to="/developer/devdashboard" style={{ textDecoration: 'none', color: 'black', display: 'flex', alignItems: 'center' }}>
